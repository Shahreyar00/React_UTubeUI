    ...
    return (
        <Link to="/video/test" style={{textDecoration:"none"}}>
            <Container>
                <Image 
                    type={type}
                    src="https://img.youtube.com/vi/mLUTB5TwM4o/maxresdefault.jpg"
                />
                <Details type={type}>
                    <ChannelImage 
                        type={type} 
                        src="https://yt3.ggpht.com/ytc/AKedOLQuONFgFu1BtXgGqGhmOmc8c8JqTVDADFLTOKyt4g=s176-c-k-c0x00ffffff-no-rj"
                    />
                    <Texts>
